...
export let sizeDown = function sizeDown(index, store) {
    ...
    if (viewPort[0] < viewPort[1]) {
        ...
        if (index == 2) {
            ...
            let i = 1;
            let positionInterval = () => {
                setStyle.bottom = Math.easeOutSine(i, 0, endBottom, 25) + 'px';
                setStyle.width = Math.easeOutSine(k, endWidth, viewPort[0] - endWidth, 25) + 'px';
                setStyle.height = Math.easeOutSine(k, endHeight, viewPort[1] - endHeight, 25) + 'px';
                console.log(setStyle.width);
                console.log(setStyle.height);
    ...
    if (viewPort[0] >= viewPort[1]) {
        ...
        if (index == 1) {
            ...
            let i = 1;
            let positionInterval = () => {
                setStyle.left = Math.easeOutSine(i, 0, endleft, 25) + 'px';
                setStyle.width = Math.easeOutSine(k, endWidth, viewPort[0] - endWidth, 25) + 'px';
                setStyle.height = Math.easeOutSine(k, endHeight, viewPort[1] - endHeight, 25) + 'px';
        ...
        if (index == 2) {
            ...
            let i = 1;
            let positionInterval = () => {
                setStyle.right = Math.easeOutSine(i, 0, endRight, 25) + 'px';
                setStyle.width = Math.easeOutSine(k, endWidth, viewPort[0] - endWidth, 25) + 'px';
                setStyle.height = Math.easeOutSine(k, endHeight, viewPort[1] - endHeight, 25) + 'px';
                console.log(setStyle.width);
                console.log(setStyle.height);
